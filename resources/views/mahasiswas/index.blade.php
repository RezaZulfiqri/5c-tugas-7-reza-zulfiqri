...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card p-4">
            <h3 class="fw-bold">Data Mahasiswa UNSIKA</h3>
            <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr @if($loop->odd)  style="background-color: #f1f3f5;"  @endif>
                                ...
                                <td class="align-middle" style="text-align: center">{{ $mahasiswa->ukm }}</td>
                                <td class="align-middle" style="text-align: center">
                                    @forelse ($mahasiswa->ukms as $item)
                                        <ul class="align-middle" style="text-align: center">
                                            <li class="align-middle" style="text-align: center">{{ $item->nama_ukm }}</li>
                                        </ul>
                                        @empty
                                       <div class="text-danger"> Mahasiswa belum mengikuti UKM sama sekali. </div>
                                        @endforelse
